...
# Format Notifications from JSON Log Lines
...
In your template you can only use the variables that exist as keys in the JSON from the log line you want to catch.<br>
