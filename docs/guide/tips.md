...
2. **Regex**:
   ...
   - use `hide_regex_in_title: true` when using very long regex patterns to have a cleaner notification title<br> (or hide found keywords from the title altogether with your own custom `notification_title` ([see settings](./config_sections/settings))
