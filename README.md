...
This config only covers the essential settings, you can find a full config walkthrough [here](#-Configuration-Deep-Dive) or just take a look at this [example config](/config.yaml).
