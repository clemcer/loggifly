...
When running the container rootless it is a bit more complicated. You have to set the `userns` which unfortunately can not be set in the docker compose.<br>
...
Environment=CONTAINERS="vg-backend"
